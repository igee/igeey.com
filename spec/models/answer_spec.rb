...
describe Answer do
  before do
    ...
    @answer_1 = Answer.new(:user_id=>@user.id, :question_id=>@question.id, :content=>'answer1234')
    @answer_1.save
  end
  
  describe 'validation' do
    it 'should be created by question' do
      @answer = Answer.new(:user_id=>@user_1.id, :content=>'answer1234')
      @answer.should_not be_valid
      
      @answer = Answer.new(:user_id=>@user_1.id, :question_id=>@question.id, :content=>'answer1234')
    ...
    it 'should be created by content' do
      @answer = Answer.new(:user_id=>@user_1.id, :question_id=>@question.id)
      @answer.should_not be_valid
    ...
    it 'content should not be less than 10 words' do
      @answer = Answer.new(:user_id=>@user_1.id, :question_id=>@question.id, :content=>'answer123')
      @answer.should_not be_valid
  ...
  it 'should be voted' do
    @vote = Vote.new(:user_id=>@user_1.id, :voteable_type=>@answer_1.class.to_s, :voteable_id=>@answer_1.id)
