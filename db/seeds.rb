...
Venue.new(:name => '太阳村',:geo_id => 1,:category => '1',:creator_id => 1,:latitude => "40.21106465394306",:longitude => "116.53745901684572",:info => "").save
Venue.new(:name => '八里庄流浪狗收容站',:geo_id => 1,:category => '3',:creator_id => 1,:latitude => "39.91612252026889",:longitude => "116.49694693188478",:info => "社区里的流浪狗收容站，有20多只流浪狗在这里生活。").save
