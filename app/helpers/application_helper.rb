module ApplicationHelper
  ...
  def sync_form_tag(form)
    ...
    html << "　#{link_to '无法勾选同步？快去设置吧',setting_path,:target => '_blank',:class => 'with_explain',:title => '点击页面右上角的用户设置，连接你的社区帐号，把你公益行动分享给你的朋友。'}" unless current_user.sina? && current_user.douban?
    html
  end
end
